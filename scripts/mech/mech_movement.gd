...
const THRUSTER_LOOP_SOUND: AudioStream = preload(
	"res://audio/sfx/pixabay/thestoryrug-continuous-bass-rumble-336529.mp3"
)
const THRUSTER_BURST_SOUND: AudioStream = preload(
	"res://audio/sfx/kenney/lowFrequency_explosion_001.ogg"
)
const FOOTSTEP_SOUND: AudioStream = preload(
	"res://audio/sfx/pixabay/universfield-heavy-walking-footsteps-352771.mp3"
)
